...
public class ListOrdersSample {
    ...
    public static void main(String[] args) {
       ...
       createdAfter.setMonth(04);
       createdAfter.setDay(15);
...
//        request.setTFMShipmentStatus(tfmShipmentStatus);
        ...
        // Make the call.
        	ListOrdersResponse resp = ListOrdersSample.invokeListOrders(client, request);
        	ListOrdersResult res = resp.getListOrdersResult();
        	List<Order> orders = res.getOrders();
        	
        	for (Order o : orders){
        		System.out.println(o.getAmazonOrderId()+" ----> "+o.getBuyerName());
        	}
